...
function pagination($url, $page, $total){
    ...
    if ($page == 1) {
        ...
        $out.='<li class="page-item"><a class="page-link" href="'.$url.'">&Lt;</a></li>';
    } else {
        $out.='<li class="page-item"><a class="page-link" href="'.$url.'&amp;page='.($page - 1).'">&Lt;</a></li>';
    }
    ...
    // next
    if ($page < $total) {
        $out.= '<li class="page-item"><a class="page-link" href="'.$url.'&amp;page='.($page + 1).'">&Gt;</a></li>';
    } else {
        $out.= '<li class="page-item disabled"><a class="page-link" href="#" aria-label="Previous">
